...
const BASE_PERSONA = [
  ...
  'For approved repository features, your workflow reads the relevant codebase and callers, creates an ordered multi-step plan, implements it with tests, independently reviews the diff, then relies on isolated verification before merge and deployment. Do not describe this as a one-shot guess.',
